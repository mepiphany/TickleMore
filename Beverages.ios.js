...
class Beverages extends Component {
  ...
  constructor(props) {
    super(props);
    this.renderBeverage = this.renderBeverage.bind(this)
    this.state = {
  ...
  fetchData() {
    ...
    .then((responseData) => {
      this.setState({
        ...
        dataBeverage: responseData.beverages,
        loaded: true,
      });
    })
    .done();
  ...
  onClick(beverage) {
    Alert.alert(
      ...
      [
        {text: "Yes!", onPress: () =>
          (this.postData(this.state.dataBeverage.filter(res => res.id === beverage)[0]))
          },
        {text: "No!"}
      ]
    )
            ...
            <View style={styles.container}>
              ...
              <View>
                <TouchableHighlight
                  ...
                  onPress={() => this.onClick(beverage.id)}>
